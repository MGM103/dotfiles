...
--  NOTE: Must happen before plug-ins are loaded (otherwise wrong leader will be used)
vim.g.mapleader = " "
...
require("lazy").setup({
	...
	{ -- You can easily change to a different colorscheme.
		...
		init = function()
			...
			-- Set warning text colour to its own unique more visible colour
